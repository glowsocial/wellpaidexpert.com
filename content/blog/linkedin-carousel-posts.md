---
title: "LinkedIn Carousel Posts: How to Create Them and Why They Work"
description: "LinkedIn carousel posts (PDF documents posted as slides) consistently outperform single images and text posts for reach and saves. Here's how to create them, what to put in them, and how to make them work for your business."
slug: "linkedin-carousel-posts"
date: "2024-07-08"
tags: ["linkedin", "content-creation", "social-media"]
schema_type: "HowTo"
faq:
  - question: "What are LinkedIn carousel posts?"
    answer: "LinkedIn carousel posts are multi-page PDF documents uploaded as native LinkedIn posts. They appear in the feed as swipeable slides, letting users flick through 2–20 pages of content. They typically get 2–3x more impressions than single-image posts because LinkedIn's algorithm favors content that keeps people engaged on the platform."
  - question: "How do you create a LinkedIn carousel post?"
    answer: "Design your slides in Canva, PowerPoint, or Google Slides (one slide per page, 1080x1080px square or 1080x1350px portrait). Export as a PDF. On LinkedIn, click 'Start a post,' then click the document icon, upload your PDF, add a title, and write a compelling post caption that makes people want to swipe."
  - question: "How many slides should a LinkedIn carousel have?"
    answer: "The ideal LinkedIn carousel has 8–15 slides. Fewer than 5 slides gives the algorithm less reason to show the post to new people. More than 20 slides loses most readers before the end. Structure it with a hook slide (1), content slides (2–13), and a clear CTA on the last slide."
  - question: "What should a LinkedIn carousel post be about?"
    answer: "The best LinkedIn carousel post topics are: frameworks and step-by-step systems, mistakes to avoid in a specific area, before/after comparisons, curated lists (tools, resources, examples), and simplified explanations of complex concepts. Educational content that saves the reader time performs best."
---
